...
pub struct AirspeedIndicatorProps2 {
...
#[non_exhaustive]
pub struct AirspeedIndicator2;

impl Component for AirspeedIndicator2 {
    type Message = ();
    type Properties = AirspeedIndicatorProps2;
    ...
    fn view(&self, ctx: &yew::Context<Self>) -> Html {
        airspeed_indicator2(ctx.props())
    }
}

/// Indicates airspeed. The max airspeed is configurable.
pub fn airspeed_indicator2(props: &AirspeedIndicatorProps2) -> Html {
    let box_style = css!(
        r#"
        width: 100%;
        height: 100%;
    ...
    let airspeed_indicator_outside = include_str!("./svg_data_uri/airspeed_indicator_outside.svg");
    let airspeed_indicator_hand = include_str!("./svg_data_uri/airspeed_indicator_hand.svg");
